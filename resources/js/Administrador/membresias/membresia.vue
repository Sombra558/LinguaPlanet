<template>
    <div class="container" style="position:relative;">
        <h3 class="color-black mb-4">Membresias</h3>
        <div class="row">
        ...
        <div class="popover d-none" role="tooltip" style="width: 12rem; position: absolute;top: 48px;left: -9.3rem;">
            ...
            <div class="popover-body px-4">
                <div class="row py-2">
                    <div class="col">
                        <a @click.prevent="membresiamodal(membresiaSelected,'editar')" href="#" class="color-black">
                ...
                <div class="row py-2">
                    <div class="col">
                        <a @click.prevent="eliminarMembresia(membresiaSelected)" href="#" class="color-black">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
