                                ...
                                <div class="accordion" id="accordionExample">
                                    <div class="card" v-for="(modulo, index) in curso.modulos" :key="modulo.id">
                                        <div class="card-header" id="headingOne">
                                            <div class="row">                                                
                                                <div class="col-6">
                                                    <a v-if="modulo.clases.length" href="#" data-toggle="collapse" :data-target="`#collapse${index}`" aria-expanded="true" :aria-controls="`collapse${index}`">
                                                        <span class="list-modulos-header">{{modulo.nombre}}</span>
                                                    </a>
                                                    <span v-else class="list-modulos-header">{{modulo.nombre}}</span>
                                                    <span class="d-block color-plomo">{{modulo.clases.length}} Clases - <Cont :modulo="modulo" /> Actividades</span>                                                    
                                                </div>
                                                <div class="col-6 d-flex justify-content-end align-items-center">
                                                    <span :class="[ 'modulo', 'm'+index ,'btn-deck d-flex align-items-center']">
                                                        <button class="transparent-button color-plomo" @click.prevent="seleccionarModuloModal(modulo,'clase',modulo)">
                                                            +
                                                            <span class="edit-desktop">
                                                                Agregar
                                                            </span>
                                                        </button>
                                                        ...
                                                        <button class="img-btn" @click.prevent="eliminarModulo(modulo)">
                                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <button type="button" class="btn-options" @click="showOptions($event)" style="position: relative;">
