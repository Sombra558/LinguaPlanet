<template>
    <div class="bg-white" style="height: 100vh;">
        ...
        <center style="height: 85%;" v-else>
			<div v-if="actividad.tipo==='Libros'">
				<svg v-if="openbook===false" @click.prevent="openbook=true;" width="432" height="388" viewBox="0 0 432 388" fill="none" xmlns="http://www.w3.org/2000/svg">
