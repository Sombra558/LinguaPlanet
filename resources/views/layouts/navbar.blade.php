<nav class="navbar navbar-expand-md navbar-light bg-white">
    <div class="container">
        <a class="navbar-brand m-0" href="https://linguaplanet.com.mx/">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav mr-auto">
                <li class="nav-item" >
                    <a class="nav-link text-primary" href="https://linguaplanet.com.mx/">{{ __('Home') }}</a>
                </li>
                <li class="nav-item" >
                    <a class="nav-link text-primary" href="{{ route('courses.index') }}">{{ __('Courses') }}</a>
                </li>
                <li class="nav-item" >
                    <a class="nav-link text-primary" href="https://linguaplanet.com.mx//acerca-de-nosotros/">{{ __('About') }}</a>
                </li>
                <li class="nav-item" >
                    <a class="nav-link text-primary" href="https://linguaplanet.com.mx//contactanos/">{{ __('Contact us') }}</a>
                </li>
            </ul>
