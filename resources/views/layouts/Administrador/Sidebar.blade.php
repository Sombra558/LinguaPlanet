<aside class="border-end gray-back" id="sidebar-wrapper">
  <ul class="list-group pt-3">
    <li class="list-group-item border-0 my-1 sidebar-item @if(request()->routeIs('admin..home')) active @endif">
    ...
    <li class="list-group-item border-0 my-1 sidebar-item @if(request()->routeIs('admin..cursos')) active @endif">
    ...
    <li class="list-group-item border-0 my-1 sidebar-item @if(request()->routeIs('admin..cupones')) active @endif">
