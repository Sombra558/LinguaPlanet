<?php
	Route::post('/home/{perfil_id}/{curso_id}/actividad/{actividad_id}/intentos/{valor}/realizada', 'Padres\PerfilEstudiante@juegorealizado');
Route::group(['middleware' => ['auth'],'prefix' => 'home2'], function () {
